...
- `0x0009` carries temperature data, including water temperature
- `0x0259` / `0x025a` carry statistics counters such as operating days and cell runtime
...
| `0x0259` | Statistics A | operating days, reversal count, daily cell runtime |
| `0x025a` | Statistics B | lifetime cell runtime, low-salt cell runtime |
| `0x0009` | Temperature | board/water temperature |
